...
const data: { [key: string]: { [key: string]: string } } = {
  ...
  "current server info": {
    english: "Current server info",
    czech: "Aktuálni Info serveru",
  },
  ...
  "current clients": {
    ...
    czech: " Aktuální Uživatelé",
  },
  update: { english: "Update", czech: "Čas provozu" },
  "database size": { english: "Database Size", czech: "Velikost Databáze" },
  "database rows": {
    english: "Database Rows",
    czech: "Počet řádků v Databázi",
  },
};
