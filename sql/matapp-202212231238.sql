...
VALUES (1, 1, 2, 1, 0), (2, 1, 1, 1, 1), (3, 1, 5, 1, 1), (4, 1, 3, 1, 2), (5, 1, 4, 1, 2);
...
INSERT INTO
    `ingredient_allergens`
VALUES (1, 1, 1), (2, 1, 2), (3, 2, 2), (4, 2, 3);
...
VALUES (1, '-'), (2, 'Příloha'), (3, 'Maso'), (4, 'Nápoje');
...
CREATE TABLE
    `ingredients` (
        ...
        CONSTRAINT `ingredients_FK` FOREIGN KEY (
            `ingredient_text_extension_id`
        ) REFERENCES `ingredient_text_extensions` (`id`),
...
VALUES (1, 'Chleba', 2, 0, '2', 1), (2, 'Párky', 3, 10, '2', 1), (3, 'Kečup', 1, 5, '50', 3), (4, 'Hořčice', 1, 5, '50', 3), (5, 'Rohlík', 2, 0, '2', 1), (6, 'Vajičko', 1, 7, '1', 1), (7, 'Slanina', 3, 10, '3', 1), (8, 'Čaj', 4, 5, '300', 3), (9, 'Káva', 4, 10, '200', 3), (10, 'Džus', 4, 20, '250', 3), (11, 'Minerálka', 4, 15, '250', 3);
