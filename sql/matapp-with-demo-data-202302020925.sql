...
INSERT INTO `dish$ingredients` VALUES (6,2,2,1,0),(7,2,4,1,1),(8,2,1,1,1);
...
INSERT INTO `dish_categories` VALUES (0,'Hlavní chod');
...
INSERT INTO `dishes` VALUES (2,'jak',13,0),(3,'jak',13,0);
...
INSERT INTO `ingredient_allergens` VALUES (3,2,2),(4,2,3),(9,3,4),(16,1,41),(17,8,1),(18,8,21),(19,8,31);
...
INSERT INTO `ingredient_types` VALUES (1,'-'),(3,'Maso'),(4,'Nápoje'),(22,'Pečivo'),(2,'Příloha'),(14,'Zelenina');
...
CREATE TABLE `ingredients` (
  ...
  CONSTRAINT `ingredients_FK` FOREIGN KEY (`ingredient_text_extension_id`) REFERENCES `ingredient_text_extensions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `ingredients` VALUES (1,'Chleba',22,10,'1',1),(2,'Párky',3,10,'2',1),(3,'Kečup',1,5,'50',3),(4,'Hořčice',1,5,'50',3),(5,'Rohlík',2,0,'2',1),(6,'Vajičko',1,7,'1',1),(7,'Slanina',3,10,'3',1),(8,'Tmavý Chleba',22,15,'1',3),(9,'Káva',4,10,'200',3),(10,'Džus',4,20,'250',3),(13,'Čistá voda',1,20,'1',1),(14,'Voda 2',1,20,'1',1);
...
INSERT INTO `users` VALUES (1,'admin','21232f297a57a5a743894a0e4a801fc3',NULL,2),(2,'pob','098f6bcd4621d373cade4e832627b4f6',1,1);
...
-- Dump completed on 2023-02-02  9:25:45
